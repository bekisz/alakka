 ...
 *
 */
//  * @tparam InputType Has to be the same as the subtype
trait Input extends HasMultiplicity {
  ...
  /**
   * Uses reflection to fetches all the fields within this instance,
   * that are are the subtype of ParameterBase
    * @return
   */
